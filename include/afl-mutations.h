...
u32 full_splice_array[MUT_SPLICE_ARRAY_SIZE] = {MUT_FLIPBIT,
  ...
  #define MUT_TEXT_NORMAL_ARRAY_SIZE 99
u32 text_normal_splice_array[MUT_TEXT_NORMAL_ARRAY_SIZE] = {
  ...
  #define MUT_TEXT_SPLICE_ARRAY_SIZE 107
u32 text_full_splice_array[MUT_TEXT_SPLICE_ARRAY_SIZE] = {
